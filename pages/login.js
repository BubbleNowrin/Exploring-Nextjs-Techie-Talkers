...
const login = () => {
    ...
    return <div>
        <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-200 dark:text-gray-100 mx-auto my-28">
            ...
            <p className="text-xs text-center sm:px-6 dark:text-gray-400">Donot have an account?
